...
<div class="article-accordion">
  <details>
    ...
    <div class="article-abstract">
      In this project, we will leverage AI, together with fine-grained geographic data from Street View images and textual data from Google Business profiles, to develop new measures of segregation and mixing across sexual, gender, and ethno-linguistic groups in space. Using these micro-level measures, we plan to study the dynamics of conflict, integration, and discrimination in ways that weren't possible before, concentrating on visibility instead of mere demographic presence.
    </div>
  </details>
