...
## Intro: Using Large Language Models in Social Science Research
* *Semester:*  Winter 2024/25 + 2025/2026
* *Institution:* Humboldt-Universität zu Berlin, Department of Social Sciences   
* *Position:* Guest Lecturer   
* *Library:* [here](https://www.zotero.org/groups/5834393/llms_in_social_sciences/library)  
* *Repository:* [GitHub](https://github.com/violeta-haas/Intro-LLMs-in-Social-Science-Research)

<div style="border: 1px solid #d1d5db; border-radius: 6px; padding: 16px; margin: 16px 0; background-color: #f9fafb; transition: all 0.2s;">
    ...
    <div style="display: flex; align-items: flex-start; gap: 12px;">
      <div style="flex: 1;">
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
          <svg style="width: 16px; height: 16px; fill: #24292f; flex-shrink: 0;" viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path>
          </svg>
          <span style="font-weight: 600; color: #0969da; font-size: 14px;">violeta-haas / Intro-LLMs-in-Social-Science-Research</span>
        </div>
        <p style="color: #656d76; font-size: 14px; margin: 0 0 8px 0;">Guest lecture materials on using Large Language Models (LLMs) for social science research, with a focus on text classification.</p>
        <div style="display: flex; gap: 16px; font-size: 12px; color: #656d76;">
          <span>📁 R code</span>
          <span>📊 Example datasets</span>
          <span>📝 Quarto slides</span>
        </div>
      </div>
    </div>
  </a>
